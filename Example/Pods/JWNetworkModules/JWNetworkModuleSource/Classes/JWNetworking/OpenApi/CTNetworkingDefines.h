...
typedef NS_ENUM (NSUInteger, CTAPIManagerErrorType){
    ...
    CTAPIManagerErrorTypeTimeout,         // 请求超时。AFNetworking默认60s
...
typedef NS_ENUM(NSUInteger, CTAPIManagerCacheKeyMask) {
    CTAPIManagerCacheKeyMaskDefault = 0,
    CTAPIManagerCacheKeyMaskDefaultButParams = 1,
    CTAPIManagerCacheKeyMaskCustom = 2,
};
...
extern NSString * _Nonnull const kCTUserTokenNotificationUserInfoKeyManagerToContinue;//Notification UserInfo's Key
